...
class ForumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forum" do
    assert_difference('Forum.count') do
      post forums_url, params: { forum: { body: @forum.body, tournament_id: @forum.tournament_id, user_id: @forum.user_id } }
    end
  ...
  test "should update forum" do
    patch forum_url(@forum), params: { forum: { body: @forum.body, tournament_id: @forum.tournament_id, user_id: @forum.user_id } }
