...
ActiveRecord::Schema.define(version: 20180719113427) do
  ...
  create_table "forums", force: :cascade do |t|
    ...
    t.index ["tournament_id"], name: "index_forums_on_tournament_id"
    t.index ["user_id"], name: "index_forums_on_user_id"
  end

  create_table "japan_votes", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "tournament_id"
